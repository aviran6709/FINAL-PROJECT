...
React.useEffect(() => {
   ...
   return () => document.removeEventListener('keydown', closeByEscape)
    ...
    <Navigation  openPopup={openPopup} logout={props.logout} isDarkThem={false} ></Navigation>   
    <PopupSignup
    togglePopups={togglePopups}
     isOpen={isOpen && !signinPopup}   
     onClose={closePopups} createNewUser={props.registerFunc} />
    <PopupSignin isOpen={isOpen && signinPopup} togglePopups={togglePopups} onClose={closePopups}login={props.loginFunc} />
