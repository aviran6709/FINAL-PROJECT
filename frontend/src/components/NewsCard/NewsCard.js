...
const NewsCard = (props) => {
  ...
  const {   title, urlToImage, url, publishedAt,  content, source ,keyword } = props.data;
...
const onClickHandler =()=>{
  ...
  return (
    ...
    >
      ...
      <button className={props.isDarkThem?"card__btn-saved ":`card__btn ${isSavedCard ? " card__btn-clicked" :"card__btn"}`  } onClick={buttonHandler} onMouseEnter={toggleSigninBtn} onMouseLeave={toggleSigninBtn}></button>
